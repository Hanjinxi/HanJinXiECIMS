...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	...
	<!-- <div title="营销管理" data-options="selected:true,iconCls:'icon-yxgl'" style="padding: 10px">
		...
		<!-- <div title="系统管理"  data-options="iconCls:'icon-jcsjgl'" style="padding:10px">
			<a href="javascript:openTab('导航栏管理','navigationBar.jsp','icon-sjzdgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-sjzdgl'" style="width: 150px;">导航栏管理</a>
		</div> -->
